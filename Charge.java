		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(ClientChargeThread.myChargePatientInfo.size()==0){
					JOptionPane.showMessageDialog(contentPane,"µ±Ç°Ã»ÓÐ¸¶¿îÐÅÏ¢");
					return ;								
				}
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(ClientChargeThread.myPredictPatinetInfo.size()==0){
					JOptionPane.showMessageDialog(contentPane,"µ±Ç°Ã»ÓÐ¹ÒºÅÐÅÏ¢");
					return;
				}
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(name.getText().equals("")||sex.getText().equals("")||age.getText().equals("")){
					JOptionPane.showMessageDialog(contentPane,"ÊäÈë´íÎó");
					return ;
				}
